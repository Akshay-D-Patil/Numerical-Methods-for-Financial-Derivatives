...
Purpose             : The objective of this Python program is to solve a tridiagonal 
                      system of equations using the Brennan-Schwartz algorithm. 
                      Brennan-Schwartz algorithm is a simplied version of the Gaussian 
                      elimination. This algorithm involves two core substitutions, 
                      a forward loop and a backward loop in which we calculate a 
                      multiplier and use it as required. This algorithm can be used 
                      to solve any generate tridiagonal matrix. 
