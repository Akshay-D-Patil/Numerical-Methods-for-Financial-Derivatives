...
Purpose             : The objective of this Python program is to solve a 
                      tridiagonal system of equations using the PSOR algorithm. 
                      PSOR algorithm is an extension of Gauss-Seidel alogithm 
                      which is an extension of Jacobi algorithm. It is an 
                      iterative method for solving linear system of equations. 
                      PSOR algorithm is very useful is pricing American style 
                      options. We use a relaxation parameter and a convergence 
                      condition so that the iterative solution converges. This 
                      algorithm can be used to solve any general tridiagonal 
                      matrix. 
                         
Numerical Methods   : Solving Tridiagonal system of equations, PSOR Algorithm
...
def psor(a,b,M,N,accuracy):
    ...
    while (iter_counter == 0 or stability_ind == 1) : # loop for the iteration \
